...
export default function GallerySkeleton() {
  return (
    <div className="flex flex-col gap-4 w-full md:w-[45%] xl:w-1/4 h-fit rounded-3xl">
      <div className="flex bg-slate-200 rounded-3xl w-full h-[350px] justify-center items-center animate-pulse mb-4">
        <svg
